...
public:
	...
	//判定
	bool Match_CommentFrom( int nPos, int nLineLen, const wchar_t* pLine ) const;	//	行コメントに値するか確認する
	int Match_CommentTo( int nPos, int nLineLen, const wchar_t* pLine ) const;	//	行コメントに値するか確認する
